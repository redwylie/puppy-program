        ...
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 16px' }}>
          <div style={{ padding: '14px 0 0' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
              ...
              <div>
                <h1 style={{ fontSize: 17, fontWeight: 700, color: 'var(--text)', margin: 0 }}>Goldiva Puppy Program</h1>
                <p style={{ fontSize: 12, color: 'var(--text-muted)', margin: 0 }}>Based on Goldiva Goldens course materials</p>
              </div>
            </div>
          </div>
